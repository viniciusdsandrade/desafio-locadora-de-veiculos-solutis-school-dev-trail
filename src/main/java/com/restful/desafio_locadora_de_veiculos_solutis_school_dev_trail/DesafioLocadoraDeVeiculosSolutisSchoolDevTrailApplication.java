...
public class DesafioLocadoraDeVeiculosSolutisSchoolDevTrailApplication {
    ...
    @Schema(hidden = true)
    private static final String vini_path_desktop = "C:\\Users\\Pichau\\Desktop\\desafio-locadora-de-veiculos-solutis-school-dev-trail\\z_documents\\database\\seed\\script_locadora_veiculos_solutis_seed.sql";

    @Schema(hidden = true)
    private static final String vini_path_notebook = "C:\\Users\\vinic\\OneDrive\\Área de Trabalho\\desafio-locadora-de-veiculos-solutis-school-dev-trail\\z_documents\\database\\seed\\script_locadora_veiculos_solutis_seed.sql";
        ...
        return args -> {
            ...
            if (!flagFile.exists()) {
                try {
                    ...
                    if (fileCreated) System.out.println("Arquivo de flag criado: banco de dados inicializado.");
                    else System.out.println("Arquivo de flag já existia.");
                } catch (Exception e) {
